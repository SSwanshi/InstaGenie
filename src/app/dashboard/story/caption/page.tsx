...
import { Upload, Image as ImageIcon, Sparkles, Copy, Check, Wand2, FileText, Palette, Smile } from "lucide-react";
...
export default function StoryCaptionPage() {
    ...
    const handleGenerate = async () => {
        ...
        // Simulate API call
        setTimeout(() => {
            setCaption("✨ Just another magic monday! What's your focus this week? 👇");
            setLoading(false);
        }, 2000);
    };
                                    ...
                                    >
                                        {previewUrl ? (
                                            ...
                                            <div className="flex flex-col items-center justify-center h-full text-gray-400 group-hover:text-orange-400 transition-all duration-500">
                                                ...
                                                <p className="text-lg font-semibold mb-2">Drop your story image here</p>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex flex-col items-center gap-3 relative z-10 transition-transform duration-300 group-active:scale-95">
                                                <IconComponent className={`w-6 h-6 ${tone === t.name ? "text-white" : "text-orange-400"}`} />
                            ...
                            <div className="relative mt-12 bg-black/40 rounded-[2.5rem] border border-orange-500/30 p-8 md:p-10 shadow-inner overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-700">
                                ...
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold text-white">Your Story Caption</h3>
                                            <p className="text-sm text-gray-500">Short & snappy for stories</p>
                                        </div>
                                    </div>
