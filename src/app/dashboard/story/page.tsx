      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">
            Choose Your <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Story Element</span>
          </h2>
        ...
        <div className="relative bg-[#0f0720]/40 backdrop-blur-md rounded-[3rem] p-8 md:p-16 border border-white/5 overflow-hidden shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white mb-4">Pro Tips for Better Stories</h3>
            <p className="text-gray-400 text-lg">Maximize your story performance with these AI-powered insights</p>
          </div>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group text-center p-8 bg-black/20 rounded-[2rem] border border-white/5 hover:border-pink-500/30 transition-all duration-300">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">Stories are meant to be quick - use concise, impactful content.</p>
            </div>
            ...
            <div className="group text-center p-8 bg-black/20 rounded-[2rem] border border-white/5 hover:border-yellow-500/30 transition-all duration-300">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">Regular story posting keeps your audience engaged.</p>
            </div>
          </div>
        </div>
      </div>
