...
export default function PostHashtagPage() {
    ...
    const [tone, setTone] = useState("Descriptve");
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setHashtag("⚠️ Failed to generate hashtag. Please try again.");
            }
        } catch (error) {
            console.error("Request failed:", error);
            setHashtag("⚠️ Something went wrong.");
        }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base text-gray-300 max-w-xl mx-auto">
            Transform your posts with AI-powered hashtags that reach to  the perfect tone
          </p>
        </div>
            ...
            {hashtag && (
              <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl border border-purple-400/30 p-6 space-y-4">
                ...
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                  <p className="text-gray-100 leading-relaxed text-lg">{hashtag}</p>
                </div>
