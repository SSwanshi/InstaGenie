      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">
            Choose Your <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Post Element</span>
          </h2>
        ...
        <div className="relative bg-[#0f0720]/40 backdrop-blur-md rounded-[3rem] p-8 md:p-16 border border-white/5 overflow-hidden shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white mb-4">Pro Tips for Better Posts</h3>
            <p className="text-gray-400 text-lg">Maximize your post performance with these AI-powered insights</p>
          </div>

          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group text-center p-8 bg-black/20 rounded-[2rem] border border-white/5 hover:border-purple-500/30 transition-all duration-300">
              <div className="w-12 h-12 text-purple-400 mx-auto mb-6 group-hover:scale-110 transition-transform">
                <Target className="w-full h-full" />
              </div>
              <h4 className="text-xl font-bold text-white mb-3">Context is King</h4>
              <p className="text-sm text-gray-400 leading-relaxed">Briefly explain the context of your post and the mood you want to convey.</p>
            </div>
            <div className="group text-center p-8 bg-black/20 rounded-[2rem] border border-white/5 hover:border-green-500/30 transition-all duration-300">
              <div className="w-12 h-12 text-green-400 mx-auto mb-6 group-hover:scale-110 transition-transform">
                <TrendingUp className="w-full h-full" />
              </div>
              <h4 className="text-xl font-bold text-white mb-3">Follow Trends</h4>
              <p className="text-sm text-gray-400 leading-relaxed">Stay updated with trending hashtags and audio to boost your visibility.</p>
            </div>
            <div className="group text-center p-8 bg-black/20 rounded-[2rem] border border-white/5 hover:border-orange-500/30 transition-all duration-300">
              <div className="w-12 h-12 text-orange-400 mx-auto mb-6 group-hover:scale-110 transition-transform">
                <Zap className="w-full h-full" />
              </div>
              <h4 className="text-xl font-bold text-white mb-3">Vibe Matters</h4>
              <p className="text-sm text-gray-400 leading-relaxed">Maintain the consistency by mentioning your color scheme and aesthetic.</p>
            </div>
          </div>
        </div>
      </div>
