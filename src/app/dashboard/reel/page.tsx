...
export default async function StoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-red-50 to-yellow-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Header */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-medium leading-relaxed max-w-3xl mx-auto">
              Create engaging Instagram reels with AI-powered captions, music, and descriptions, and Trendy topics
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Choose Your Reel Video Element
          </h2>
        ...
        <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Pro Tips for Better Reels Creation</h3>
            <p className="text-gray-600 dark:text-gray-300">Maximize your reel performance with these AI-powered insights</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Reels are meant to be quick - use concise, impactful content</p>
            </div>
            <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm">
            ...
            <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Regular reel posting keeps your audience engaged</p>
            </div>
          </div>
        </div>
      </div>
