...
export default function ReelDescriptionPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/api/reels/generate-description", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-primary mb-4 tracking-tight">
            Reel Description Generator
          </h1>
          <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Create reel descriptions that boost engagement in seconds
          </p>
        </div>
